                ...
                <form action="/test-action" method="post" id="reg-login-form">
                    <ul>
                        ...
                        <li class="reg-user-input">
                            ...
                            <input type="password" class="reg-user-password-input" name="user_password" placeholder="Password" />
                        </li>
                        <li class="reg-password-repeat-input">
                            <label for="name">Repeat your password:</label><br />
                            <input type="password" class="reg-user-password-repeat" name="user_password_repeat" placeholder="Repeat password" />
                        </li>
