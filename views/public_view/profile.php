...
require_once ROOT_PATH . 'controllers/childInfo.php';
        ...
        <div id="admin-controls">
            <div id="user-list">
                ...
                <div id="pagination-controls">
                    <button id="prev-page">&larr; Back</button>
        ...
        foreach ($userChildrenList as $child) { ?>
            <a onclick="setSessionChildId(<?php echo $_SESSION['user_id']; ?>, <?php echo $child['id']; ?>)">
                <div class="pr-child-container">
                    ...
                    <button id="pr-child-delete" onclick="deleteChild(<?php echo $child['id']; ?>)">Delete</button>
                </div>
            </a>
    <?php
        }
...
<div id="pr-child-info">
    <div id="pr-first-row">
        <?php if (!empty($userChildrenList)) { ?>
            ...
            <div id="pr-child-info">
                <!-- metdod -->
                <form method="post" id="pr-child-data-form"> <!-- action="./controllers/ugggateChildInfo.php"-->
                    <ul id="pr-2col-table">
                        <li>
                            <label for="Name">Name:</label>
                            <input type="text" id="pr-name-input" class="pr-child-info-input" name="name" placeholder="Name" value="<?php echo $childInfo['fullname']; ?>" />
                        </li>
                        <li>
                            <label for="date-of-birtd">Date of birth:</label>
                            <input type="date" id="pr-dob-input" class="pr-child-info-input" name="date-of-birth" placeholder="Date of birth" value="<?php echo $childInfo['birthday']; ?>" />
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <input type="text" id="pr-height-input" class="pr-child-info-input" name="height" placeholder="Height" value="<?php echo $childInfo['height']; ?>" />
                        </li>
                        <li>
                            <label for="hobby">Favorite hobby:</label>
                            <input type="text" id="pr-hobby-input" class="pr-child-info-input" name="hobby" placeholder="Hobby" value="<?php echo $childInfo['fav_hobby']; ?>" />
                        </li>
                        <li>
                            <label for="food">Favorite food:</label>
                            <input type="text" id="pr-food-input" class="pr-child-info-input" name="food" placeholder="Food" value="<?php echo $childInfo['fav_food']; ?>" />
                        </li>
                            ...
                            <tbody>
                                <?php foreach ($medicalRecords as $record) { ?>
                                    <tr class="row">
                                        ...
                                        <td>
                                            ...
                                            <input type="date" class="pr-medical-record-date" name="medical-record-date" placeholder="Date of record" value="<?php echo $record['record_date']; ?>" disabled />
                                        </td>
                                        <td>
                                ...
                                <tr class="row pr-new-medical-record" <?php echo empty($medicalRecords) ? 'style="display: contents;"' : ''; ?>>
                                    ...
                                    <td>
                                        ...
                                        <input type="date" class="pr-medical-record-date pr-new-med-rec-date" name="medical-record-date" placeholder="Date of record" />
                                    </td>
                                    <td>
            ...
            ?>
                <div class="<?php echo $memory['important'] != 0 ? "pr-important-memory" : "pr-not-important-memory" ?> pr-memory">
                    <div id="pr-old-style">
                        ...
                        <div></div>
                        <div></div>
                        <button class="pr-delete-memory" onclick="deleteMemory(<?php echo $memory['id']; ?>)">x</button>
                    </div>
...
<?php } else { ?>
    <form method="post" id="pr-child-data-form">
        <ul id="pr-2col-table">
            <li>
                <label for="Name">Name:</label>
                <input type="text" id="pr-name-input" class="pr-child-info-input" name="name" placeholder="Name" />
            </li>
            <li>
                <label for="date-of-birtd">Date of birth:</label>
                <input type="date" id="pr-dob-input" class="pr-child-info-input" name="date-of-birth" placeholder="Date of birth" />
            </li>
            <li>
                <label for="gender">Gender:</label>
            ...
            <li>
                <label for="height">Height:</label>
                <input type="text" id="pr-height-input" class="pr-child-info-input" name="height" placeholder="Height" />
            </li>
            <li>
                <label for="hobby">Favorite hobby:</label>
                <input type="text" id="pr-hobby-input" class="pr-child-info-input" name="hobby" placeholder="Hobby" />
            </li>
            <li>
                <label for="food">Favorite food:</label>
                <input type="text" id="pr-food-input" class="pr-child-info-input" name="food" placeholder="Food" />
            </li>
            <button type="submit" class="pr-profile-info-button">Save</button>
    </form>
    <script>
        window.onload = function() {
            newChildAdded = true;
            document.getElementById("pr-p-container").dispatchEvent(new Event('click'));
        }
    </script>
<?php
        }
...
<script src="models/profileModel.js"></script>
<script src="views/public_view/js/profile.js"></script>
<script src="controllers/js/profileController.js"></script>
